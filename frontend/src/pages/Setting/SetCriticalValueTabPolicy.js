...
const SetCriticalValueTabPolicy = (props) => {
    ...
    const getPolicyList = () => {
        ...
        axiosConf.get("/api/setting/critical/findPolicyAll/" + props.target).then(res => {
    ...
    const getDefaultPolicyColumn = () => {
        ...
        },
        {
            ...
            cellRendererFramework: (params) => {
                return <WindowOpener className="inline-block" url={"/popup/setting/criticalValue/policy/reg/" + params.data.id + "?target=" + props.target} width="1400" height="800" bridge={getPolicyList}>
    ...
    const onDeleteListPolicy = () => {
        if (gridApiObj.policyNoticeGridApi) {
            ...
            if (window.confirm("삭제하시겠습니까?")) {
                ...
                axiosConf.get("/api/setting/critical/deletePolicy/" + props.target + "/" + selectedValueData).then(res => {
                    alert("삭제되었습니다.");
                    getPolicyList();
                });
            }
    ...
    return (
        <Grid container>
            ...
            <Grid item md={6} mt={.5} align="right">
                <WindowOpener className="inline-block" url={"/popup/setting/criticalValue/policy/reg/0?target=" + props.target} width="1400" height="800" bridge={getPolicyList}>
...
export default SetCriticalValueTabPolicy;