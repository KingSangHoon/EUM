...
const SetThresholdTable = React.forwardRef((props, ref) => {
            ...
            <Table stickyHeader className="table-bordered" size="small">
                <TableHead className="thead-light">
                    ...
                    >
                        ...
                        <TableCell align="center" className="bg-green font-white" sx={{ width: "14rem" }}>Level-1</TableCell>
                        <TableCell align="center" className="bg-yellow font-white" sx={{ width: "14rem" }}>Level-2</TableCell>
                        <TableCell align="center" className="bg-orange font-white" sx={{ width: "14rem" }}>Level-3</TableCell>
                        <TableCell align="center" className="bg-redorange font-white" sx={{ width: "14rem" }}>Level-4</TableCell>
                        <TableCell align="center" className="bg-danger font-white" sx={{ width: "14rem" }}>Level-5</TableCell>
                        {/* <Badge badgeContent={"Level-3"} classes={{ badge: "bg-orange font-white" }}></Badge> */}
                    </TableRow>
                </TableHead>
                {ChildrenResourceTb}
            </Table>
...
export default SetThresholdTable;