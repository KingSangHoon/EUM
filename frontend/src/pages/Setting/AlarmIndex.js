...
const AlarmIndex = () => {
    ...
    },
    {
        ...
        cellRendererFramework: (params) => {
            return <WindowOpener className="inline-block" url={"/popup/setting/alarm/reg/" + params.data.alarmId} width="1400" height="840" bridge={getPolicyList}>
    ...
    const getPolicyList = () => {
        ...
        axiosConf.get('/api/setting/alarm/findAll').then(res => {
    ...
    return (
        <Grid container>
            ...
            <Grid item md={6} mt={.5} align="right">
                <WindowOpener className="inline-block" url="/popup/setting/alarm/reg/0" width="1400" height="840" bridge={getPolicyList}>
