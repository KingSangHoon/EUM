...
const PopupSetIpBandIdcRegRegion = () => {
        ...
        setTimeout(() => {
            ...
            if (param) {
                ...
                if (params.id === "0") {
                    ...
                    axiosConf.get("/api/setting/geoIdc/findIdcPrimary/" + jsonParam.id).then(res => {
    ...
    const onSavePolicyValidation = () => {
        ...
        requestUrl = params.id === "0" ? "createIdcPrimary" : "updateIdcPrimary/" + params.id;
    ...
    return (
        <Card>
            <CardHeader title="IDC 설정"></CardHeader>
            <CardContent>
                <Box
                    component="form"
...
export default PopupSetIpBandIdcRegRegion;