...
const ModalSearchFormUri = React.forwardRef((props, ref) => {
            ...
            <Card sx={{ ...modalStyles, maxWidth: "1200px" }}>
                ...
                <CardContent>
                    <Grid container spacing={1} className="searchEl" sx={{ '& .MuiPaper-root, .MuiTextField-root': { border: "1px solid #babfc7" }, p: .5 }}>
                        ...
                        <Grid item sm={3}>
                            ...
                            <FormControlLabel control={<Checkbox name="isTextSrcIp" checked={schItem.isTextSrcIp} onChange={(e) => setInputChecked(e, schItem, setSchItem)} />} label="Text" />
                            {
                                schItem.isTextSrcIp ?
                                    ...
                                    /> :
                                    drawTypeAheadElement({ key: "srcIp", url: "/popup/search/http?uri=uri&key=srcIp&str=IP" })
                            }
                        </Grid>
                        <Grid item sm={.5} textAlign="center" sx={{ marginTop: "auto" }}>
                            <FontAwesomeIcon icon={faArrowsLeftRight} style={{ fontSize: "1rem", color: "#8c8c8c" }} />
                            ...
                            <FormControlLabel control={<Checkbox name="isTextDstIp" checked={schItem.isTextDstIp} onChange={(e) => setInputChecked(e, schItem, setSchItem)} />} label="Text" />
                            {
                                schItem.isTextDstIp ?
                                    <TextField
                                        ...
                                        onChange={(e) => setInputValue(e, schItem, setSchItem)}
                                    /> :
                                    drawTypeAheadElement({ key: "dstIp", url: "/popup/search/http?uri=uri&key=dstIp&str=IP" })
                            }
                        </Grid>
                        <Grid item sm={.25} sx={{ height: "2.5rem", marginTop: "auto" }} className="right_underline"></Grid>
                        <Grid item sm={.25} sx={{ height: "2.5rem", marginTop: "auto" }}></Grid>
                            ...
                            <FormControlLabel control={<Checkbox name="isTextBothIp" checked={schItem.isTextBothIp} onChange={(e) => setInputChecked(e, schItem, setSchItem)} />} label="Text" />
                            {
                                schItem.isTextBothIp ?
                                    <TextField
                                        ...
                                        onChange={(e) => setInputValue(e, schItem, setSchItem)}
                                    /> :
                                    drawTypeAheadElement({ key: "bothIp", url: "/popup/search/http?uri=uri&key=bothIp&str=IP" })
                            }
                        </Grid>
                            ...
                            <FormControlLabel control={<Checkbox name="isTextSrcPort" checked={schItem.isTextSrcPort} onChange={(e) => setInputChecked(e, schItem, setSchItem)} />} label="Text" />
                            {
                                schItem.isTextSrcPort ?
                                    <TextField
                                        ...
                                        onChange={(e) => setInputValue(e, schItem, setSchItem)}
                                    /> :
                                    drawTypeAheadElement({ key: "srcPort", url: "/popup/search/http?uri=uri&key=srcPort&str=Port" })
                            }
                        </Grid>
                        <Grid item sm={.5} textAlign="center" sx={{ marginTop: "auto" }}>
                            <FontAwesomeIcon icon={faArrowsLeftRight} style={{ fontSize: "1rem", color: "#8c8c8c" }} />
                            ...
                            <FormControlLabel control={<Checkbox name="isTextDstPort" checked={schItem.isTextDstPort} onChange={(e) => setInputChecked(e, schItem, setSchItem)} />} label="Text" />
                            {
                                schItem.isTextDstPort ?
                                    <TextField
                                        ...
                                        onChange={(e) => setInputValue(e, schItem, setSchItem)}
                                    /> :
                                    drawTypeAheadElement({ key: "dstPort", url: "/popup/search/http?uri=uri&key=dstPort&str=Port" })
                            }
                        </Grid>
                        <Grid item sm={.25} sx={{ height: "2.5rem", marginTop: "auto" }} className="right_underline"></Grid>
                        <Grid item sm={.25} sx={{ height: "2.5rem", marginTop: "auto" }}></Grid>
                            ...
                            <FormControlLabel control={<Checkbox name="isTextBothPort" checked={schItem.isTextBothPort} onChange={(e) => setInputChecked(e, schItem, setSchItem)} />} label="Text" />
                            {
                                schItem.isTextBothPort ?
                                    <TextField
                                        ...
                                        onChange={(e) => setInputValue(e, schItem, setSchItem)}
                                    /> :
                                    drawTypeAheadElement({ key: "bothPort", url: "/popup/search/http?uri=uri&key=bothPort&str=Port" })
                            }
                        </Grid>
                        ...
                        <Grid item sm={10.5}>
                            {drawTypeAheadElement({ key: "application", url: "/popup/search/http?uri=uri&key=application&str=Application" })}
                        </Grid>

                        {/* Transaction */}
                        <Grid item sm={1.5} sx={{ marginTop: "auto" }} textAlign="right">Transaction</Grid>
                        <Grid item sm={10.5}>
                            {drawTypeAheadElement({ key: "transaction", url: "/popup/search/http?uri=uri&key=transaction&str=Transaction" })}
                        </Grid>
                        ...
                        <Grid item sm={9.8}>
                            {
                                schItem.isTextHost ?
                                    <TextField
                                        ...
                                        onChange={(e) => setInputValue(e, schItem, setSchItem)}
                                    /> :
                                    drawTypeAheadElement({ key: "host", url: "/popup/search/http?uri=uri&key=host&str=Host" })
                            }
                        </Grid>

                        {/* URI */}
                        <Grid item sm={1.5} sx={{ marginTop: "auto" }} textAlign="right">URI</Grid>
                        <Grid item sm={.7}>
                        ...
                        <Grid item sm={9.8}>
                            {
                                schItem.isTextPage ?
                                    <TextField
                                        ...
                                        onChange={(e) => setInputValue(e, schItem, setSchItem)}
                                    /> :
                                    drawTypeAheadElement({ key: "page", url: "/popup/search/http?uri=uri&key=page&str=URI" })
                            }
                        </Grid>
                        ...
                        <Grid item sm={9.8}>
                            {
                                schItem.isTextUseragent ?
                                    <TextField
                                        ...
                                        onChange={(e) => setInputValue(e, schItem, setSchItem)}
                                    /> :
                                    drawTypeAheadElement({ key: "useragent", url: "/popup/search/http?uri=uri&key=useragent&category=userAgent&str=User Agent" })
                            }
                        </Grid>
                        ...
                        <Grid item sm={9.8}>
                            {
                                schItem.isTextReferer ?
                                    <TextField
                                        ...
                                        onChange={(e) => setInputValue(e, schItem, setSchItem)}
                                    /> :
                                    drawTypeAheadElement({ key: "referer", url: "/popup/search/http?uri=uri&key=referer&str=Referer" })
                            }
                        </Grid>
                        ...
                        <Grid item sm={9.8}>
                            {
                                schItem.isTextResponseCode ?
                                    <TextField
                                        ...
                                        onChange={(e) => setInputValue(e, schItem, setSchItem)}
                                    /> :
                                    drawTypeAheadElement({ key: "responseCode", url: "/popup/search/http?uri=uri&key=responseCode&category=httpResponseCode&str=HTTP Response Code" })
                            }
                        </Grid>
                        ...
                        <Grid item sm={10.5}>
                            {drawTypeAheadElement({ key: "httpMethod", url: "/popup/search/http?uri=uri&key=httpMethod&str=HTTP Method" })}
                        </Grid>

                        {/* Browser */}
                        <Grid item sm={1.5} sx={{ marginTop: "auto" }} textAlign="right">Browser</Grid>
                        <Grid item sm={10.5}>
                            {drawTypeAheadElement({ key: "browser", url: "/popup/search/http?uri=uri&key=browser&str=Browser" })}
                        </Grid>

                        {/* Hardware */}
                        <Grid item sm={1.5} sx={{ marginTop: "auto" }} textAlign="right">Hardware</Grid>
                        <Grid item sm={10.5}>
                            {drawTypeAheadElement({ key: "hardware", url: "/popup/search/http?uri=uri&key=hardware&str=Hardware" })}
                        </Grid>

                        {/* OS */}
                        <Grid item sm={1.5} sx={{ marginTop: "auto" }} textAlign="right">OS</Grid>
                        <Grid item sm={10.5}>
                            {drawTypeAheadElement({ key: "os", url: "/popup/search/http?uri=uri&key=os&str=OS" })}
                        </Grid>

                        {/* Platform */}
                        <Grid item sm={1.5} sx={{ marginTop: "auto" }} textAlign="right">Platform</Grid>
                        <Grid item sm={10.5}>
                            {drawTypeAheadElement({ key: "platform", url: "/popup/search/http?uri=uri&key=platform&str=Platform" })}
                        </Grid>

                        {/* Protocol */}
                        <Grid item sm={1.5} sx={{ marginTop: "auto" }} textAlign="right">Protocol</Grid>
                        <Grid item sm={10.5}>
                            {drawTypeAheadElement({ key: "protocol", url: "/popup/search/http?uri=uri&key=protocol&str=Protocol" })}
                        </Grid>
...
export default ModalSearchFormUri;