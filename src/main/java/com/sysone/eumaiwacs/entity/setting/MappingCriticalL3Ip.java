...
@Table (name = "tbl_mapping_critical_l3ip")
public class MappingCriticalL3Ip {

	@Id
	@SequenceGenerator(name="tbl_mapping_critical_l3ip_seq", sequenceName="tbl_mapping_critical_l3ip_seq", allocationSize=1)
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="tbl_mapping_critical_l3ip_seq")
   	@Column(name = "id")
	private Integer id;
