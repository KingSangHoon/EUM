...
@Table (name = "tbl_mapping_critical_l4udp")
public class MappingCriticalL4Udp {

	@Id
	@SequenceGenerator(name="tbl_mapping_critical_l4udp_seq", sequenceName="tbl_mapping_critical_l4udp_seq", allocationSize=1)
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="tbl_mapping_critical_l4udp_seq")
   	@Column(name = "id")
	private Integer id;
