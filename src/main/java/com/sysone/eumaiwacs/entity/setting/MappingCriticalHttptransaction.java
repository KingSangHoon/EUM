...
@Table (name = "tbl_mapping_critical_httptransaction")
public class MappingCriticalHttptransaction {

	@Id
	@SequenceGenerator(name="tbl_mapping_critical_httptransaction_seq", sequenceName="tbl_mapping_critical_httptransaction_seq", allocationSize=1)
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="tbl_mapping_critical_httptransaction_seq")
   	@Column(name = "id")
	private Integer id;
