...
@Table (name = "tbl_mapping_critical_traffic")
public class MappingCriticalTraffic {

	@Id
	@SequenceGenerator(name="tbl_mapping_critical_traffic_seq", sequenceName="tbl_mapping_critical_traffic_seq", allocationSize=1)
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="tbl_mapping_critical_traffic_seq")
   	@Column(name = "id")
	private Integer id;
