...
@Table (name = "tbl_mapping_critical_l4tcp")
public class MappingCriticalL4Tcp {

	@Id
	@SequenceGenerator(name="tbl_mapping_critical_l4tcp_seq", sequenceName="tbl_mapping_critical_l4tcp_seq", allocationSize=1)
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="tbl_mapping_critical_l4tcp_seq")
   	@Column(name = "id")
	private Integer id;
